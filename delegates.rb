...
=end
  ...
  def filesystemsource_pathname(options = {})
    # ^media.getty.edu/iiif/research/archives/([^/]+?)(_thumb)$
    #  -> /mirror/media.getty.edu/iiif/research/archives/$1/full.jpg
    identifier = context['identifier']
  ...
  def httpsource_resource_info(options = {})
    # ^media.getty.edu/iiif/research/archives/([^/]+?)(_thumb)$
    #  -> http://media.getty.edu/iiif/research/archives/$1/full/full/0/default.jpg
    identifier = context['identifier']
    #p ['httpsource_resource_info:identifier', identifier]
    #p ['httpsource_resource_info:m', m]
    REGEXES.each do |regex|
      m = identifier.match(regex)
      #p ['httpsource_resource_info:m', m]
      if m
        # Not the actual resource, just a stamp file
        url = 'http://' + m[1] + '/' + m[2] + '/full/full/0/default.jpg'
        #p ['httpsource_result', url]
        return url
      end
    end
  end
